...
#Region "Created by Windows form designer."
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'progressBar
        '
        Me.progressBar.Location = New System.Drawing.Point(224, 184)
...
#Region "User defined attributes"
    ...
    '
    Public Shared m_controller As CameraController
    Public Shared m_model As CameraModel
...
#End Region
    ...
    Sub UpdateWindow(ByVal from As Observable, ByVal msg As Integer, ByVal data As Integer) _
        Implements Observer.UpdateWindow
        ...
        Select Case msg
            ...
            Case updt '// Update properties.
                ...
                Dim propData As Integer = m_model.getPropertyUInt32(propertyID)
                UpdateProperty(propertyID, propData)

            Case upls '// Update an available property list.
                Dim propertyID As Integer = data
                Dim desc As EdsPropertyDesc = m_model.getPropertyDesc(propertyID)
    ...
    Public Function cameraModelFactory(ByVal camera As IntPtr, ByVal deviceInfo As EdsDeviceInfo) As CameraModel
        ...
        '// 
        If deviceInfo.szDeviceDescription <> "EOS 30D PTP" Then
...
#Region "Window Events"
    Private Sub TakeBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TakeBtn.Click
        ...
        ' Release button
        '
        m_controller.actionPerformed("takepicture")
    ...
    Private Sub ExitBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExitBtn.Click
        ' Quit button
        m_controller.actionPerformed("close")
...
#End Region
    ...
    Private Sub VBSample_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If err = EDS_ERR_OK Then
            ...
            m_model = cameraModelFactory(camera, deviceInfo)

            If IsNothing(m_model) = True Then
                err = EDS_ERR_DEVICE_NOT_FOUND
        ...
        If err = EDS_ERR_OK Then
            ...
            m_controller.setCameraModel(m_model)

            '// Make notify the model updating to the view.
            m_model.addObserver(Me)
        ...
        If err <> EDS_ERR_OK Then
            ...
            If IsNothing(m_model) = False Then
                m_model = Nothing
            End If


            If IsNothing(m_controller) = False Then
        ...
        m_controller.actionPerformed("init")


        '// Get camera properties.
        m_controller.actionPerformed("get", kEdsPropID_AEMode)
        m_controller.actionPerformed("get", kEdsPropID_Tv)
        m_controller.actionPerformed("get", kEdsPropID_Av)
        m_controller.actionPerformed("get", kEdsPropID_ISOSpeed)
        m_controller.actionPerformed("get", kEdsPropID_MeteringMode)
        m_controller.actionPerformed("get", kEdsPropID_ExposureCompensation)

        '// Get available property list.
        m_controller.actionPerformed("getlist", kEdsPropID_AEMode)
        m_controller.actionPerformed("getlist", kEdsPropID_Tv)
        m_controller.actionPerformed("getlist", kEdsPropID_Av)
        m_controller.actionPerformed("getlist", kEdsPropID_ISOSpeed)
        m_controller.actionPerformed("getlist", kEdsPropID_MeteringMode)
        m_controller.actionPerformed("getlist", kEdsPropID_ExposureCompensation)
    ...
    Private Sub AEModeCmb_SelectionChangeCommitted(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AEModeCmb.SelectionChangeCommitted
        ...
        m_controller.actionPerformed("set", kEdsPropID_AEMode, data)
    ...
    Private Sub TvCmb_SelectionChangeCommitted(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TvCmb.SelectionChangeCommitted
        ...
        id = kEdsPropID_Tv
        m_controller.actionPerformed("set", id, data)
    ...
    Private Sub AvCmb_SelectionChangeCommitted(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AvCmb.SelectionChangeCommitted
        ...
        m_controller.actionPerformed("set", kEdsPropID_Av, data)
    ...
    Private Sub ISOSpeedCmb_SelectionChangeCommitted(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ISOSpeedCmb.SelectionChangeCommitted
        ...
        m_controller.actionPerformed("set", kEdsPropID_ISOSpeed, data)
    ...
    Private Sub MeteringModeCmb_SelectionChangeCommitted(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MeteringModeCmb.SelectionChangeCommitted
        ...
        m_controller.actionPerformed("set", kEdsPropID_MeteringMode, data)
    ...
    Private Sub ExposureCompCmb_SelectionChangeCommitted(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ExposureCompCmb.SelectionChangeCommitted
        ...
        m_controller.actionPerformed("set", kEdsPropID_ExposureCompensation, data)
