...
Public Class DownloadCommand
    ...
    Private _directoryItem As IntPtr
    ...
    Protected Overrides Sub Finalize()
        '// Release item.
        If IsNothing(_directoryItem) = False Then
            EdsRelease(_directoryItem)
            _directoryItem = Nothing
    ...
    Public Overrides Function execute() As Boolean
        ...
        If err = EDS_ERR_OK Then
            VBSample.m_model.notifyObservers(strt)
        End If
        ...
        '// Release item
        If IsNothing(_directoryItem) = True Then
        ...
        If err = EDS_ERR_OK Then
            ...
            VBSample.m_model.notifyObservers(cplt)
    ...
    Public Shared Function ProgressFunc(ByVal inPercent As Integer, _
     ByVal inContext As IntPtr, ByRef outCancel As Boolean) As Long
        ...
        VBSample.m_model.notifyObservers(prog, inPercent)
        Return rtn
