      ...
      ByVal inContext As IntPtr) As Long
        ...
        Select Case inEvent
            Case kEdsObjectEvent_DirItemRequestTransfer
                VBSample.m_controller.actionPerformed("download", inRef)
    ...
    Public Shared Function handlePropertyEvent( _
        ...
        Select Case inEvent
            Case kEdsPropertyEvent_PropertyChanged
                VBSample.m_controller.actionPerformed("get", inPropertyID)
            Case kEdsPropertyEvent_PropertyDescChanged
                VBSample.m_controller.actionPerformed("getlist", inPropertyID)
        End Select
    ...
    Public Shared Function handleStateEvent( _
        ...
        Select Case inEvent
            Case kEdsStateEvent_Shutdown
                VBSample.m_controller.actionPerformed("clse")
