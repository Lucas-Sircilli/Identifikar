...
ON_WM_HSCROLL()
ON_CBN_SELCHANGE(IDC_COMBO_PS, OnPropertyChanged)
ON_CBN_SELCHANGE(IDC_COMBO_WB, OnPropertyChanged)
ON_CBN_SELCHANGE(IDC_COMBO_FE, OnPropertyChanged)
ON_CBN_SELCHANGE(IDC_COMBO_TE, OnPropertyChanged)
ON_CBN_SELCHANGE(IDC_COMBO_CS, OnPropertyChanged)
...
ON_EN_KILLFOCUS(IDC_EDIT_CT, OnPropertyChanged)
END_MESSAGE_MAP()
...
void CProcessPage::OnPropertyChanged()
{
	bool bUpdate=false;
	EdsError err;
	CString str;
...
//////////////////////////////////////////////////////
// ReflectImageProperty
// An EdsReflectImageProperty function is performed and the present parameter value is saved at a file.
void CProcessPage::OnBnClickedButton5()
{
	EdsReflectImageProperty( m_ImageRef );
}
