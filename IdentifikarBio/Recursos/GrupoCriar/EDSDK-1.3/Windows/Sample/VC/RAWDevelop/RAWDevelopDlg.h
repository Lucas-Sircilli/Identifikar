...
class CRAWDevelopDlg : public CDialog
{
	...
	bool m_bLoadDisable;
	EdsImageInfo m_ImageInfoThm;
	EdsImageInfo m_ImageInfoFull;
	int m_width;
...
inline void CRAWDevelopDlg::OnBnClickedRadioThm()
{
	...
	CString str;
	str.Format("%d",m_ImageInfoThm.effectiveRect.size.width);
	GetDlgItem(IDC_EDIT_W)->SetWindowText( str );
	str.Format("%d",m_ImageInfoThm.effectiveRect.size.height);
...
inline void CRAWDevelopDlg::OnBnClickedRadioFull()
{
	...
	GetDlgItem(IDC_EDIT_Y)->SetWindowText( "0" );
	CString str;
	str.Format("%d",m_ImageInfoFull.effectiveRect.size.width);
	GetDlgItem(IDC_EDIT_W)->SetWindowText( str );
	str.Format("%d",m_ImageInfoFull.effectiveRect.size.height);
	m_bLoadDisable =false;
	GetDlgItem(IDC_EDIT_H)->SetWindowText( str );
}
